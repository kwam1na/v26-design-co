...
export default function About() {
  ...
  return (
    <div ref={container}>
      <Page>
        <div className={styles.container}>
          <h1 className={styles.mainHeading} ref={mainHeading}>
            Let's create your personal web presence, together
          </h1>
          <section
          ...
          >
            ...
            <div className={styles.serviceContainer}>
              <h2 className={styles.serviceText}>Develop.</h2>
              <p className={styles.introBody}>
            ...
            <div className={styles.serviceContainer}>
              <h2 className={styles.serviceText}>Maintain.</h2>
              <p className={styles.introBody}>
      ...
      <section
        className={`${styles.contactContainer} ${styles.section} section`}
      >
